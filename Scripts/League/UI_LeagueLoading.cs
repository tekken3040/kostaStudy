...
public class UI_LeagueLoading : MonoBehaviour {
	...
	IEnumerator loadScene()
	{
		...
		{
			Legion.Instance.eGameStyle = GameStyle.League;
			AssetMgr.Instance.BattleSceneLoadAsync(Legion.Instance.SelectedLeague.getField().sFieldModelName, false);
		}
