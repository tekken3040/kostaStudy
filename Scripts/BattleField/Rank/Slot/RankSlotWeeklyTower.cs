...
public class RankSlotWeeklyTower : MonoBehaviour
{
    ...
    public void SetData(RankListDetail _detail)
    {
		...
		StageInfo stageInfo = StageInfoMgr.Instance.dicStageData[(UInt16)_rankListDetail.u4Value];

		_towerName.text = TextManager.Instance.GetText(stageInfo.chapterInfo.strName);
