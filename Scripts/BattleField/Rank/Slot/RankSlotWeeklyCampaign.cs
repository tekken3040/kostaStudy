...
public class RankSlotWeeklyCampaign : MonoBehaviour
{
    ...
    public void SetData(RankListDetail _detail)
    {
        ...
        tempStringBuilder.Remove(0, tempStringBuilder.Length);
        tempStringBuilder.Append(StageInfoMgr.Instance.dicStageData[(UInt16)_rankListDetail.u4Value].actInfo.u1Number.ToString());
