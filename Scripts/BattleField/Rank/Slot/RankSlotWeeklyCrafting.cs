...
public class RankSlotWeeklyCrafting : MonoBehaviour
{
    ...
    public Text _craftPoint;
    public Text _craftCnt;
    ...
    public void SetData(RankListDetail _detail)
    {
        ...
        _craftPoint.text = _rankListDetail.u4Value.ToString();
        tempStringBuilder.Remove(0, tempStringBuilder.Length);
        tempStringBuilder.Append(_rankListDetail.u4MakingCount.ToString()).Append(TextManager.Instance.GetText("mark_craft_count"));
        _craftCnt.text = tempStringBuilder.ToString();
